...
export const genderList = [
    ...
    { label: 'Genderless', value: 'genderless', key: 3 },
    { label: 'Unknown', value: 'unknown', key: 4 },
];
export const speciesList = [
    { label: 'Human', value: 'Human', key: 1 },
    { label: 'Animal', value: 'Animal', key: 2 },
    ...
    { label: 'Unknown', value: 'unknown', key: 10 },
];
